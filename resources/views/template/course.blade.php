...
@section('content')
        ...
        <div class="breadcrumbarea">
            ...
            <div class="shape__icon__2">
                <img class=" shape__icon__img shape__icon__img__1" src="{{url('frontassets/img/herobanner/herobanner__1.png')}}" alt="photo1">
                <img class=" shape__icon__img shape__icon__img__2" src="{{url('frontassets/img/herobanner/herobanner__2.png')}}" alt="photo2">
                <img class=" shape__icon__img shape__icon__img__3" src="{{url('frontassets/img/herobanner/herobanner__3.png')}}" alt="photo3">
                <img class=" shape__icon__img shape__icon__img__4" src="{{url('frontassets/img/herobanner/herobanner__5.png')}}" alt="photo4">
            </div>
                        ...
                        <div class="tab-content tab__content__wrapper with__sidebar__content" id="myTabContent">
                            ...
                            <div class="tab-pane fade  active show" id="projects__one" role="tabpanel" aria-labelledby="projects__one">
                                ...
                                <div class="row">
                                    <div class="col-xl-4 col-lg-6 col-md-12 col-sm-6 col-12" data-aos="fade-up">
                                        <div class="gridarea__wraper gridarea__wraper__2">
                                            <div class="gridarea__img">
                                                <a href="course-details.html"><img src="{{url('frontassets/img/grid/grid_1.png')}}" alt="grid"></a>
                                            ...
                                            <div class="gridarea__content">
                                                ...
                                                <div class="gridarea__price">
                                                    &#8377 32.00 <del>/ &#8377 67.00</del>
                                                    <span> <del class="del__2">Online</del></span>
                                                ...
                                                <div class="gridarea__bottom">
                                                    ...
                                                    <a href="instructor-details.html">
                                                        <div class="gridarea__small__img">
                                                            <img src="{{url('frontassets/img/grid/grid_small_1.jpg')}}" alt="grid">
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-md-12 col-sm-6 col-12" data-aos="fade-up">
                                        <div class="gridarea__wraper gridarea__wraper__2">
                                            <div class="gridarea__img">
                                                <img src="{{url('frontassets/img/grid/grid_2.png')}}" alt="grid">
                                                <div class="gridarea__small__button">
                                            ...
                                            <div class="gridarea__content">
                                                ...
                                                <div class="gridarea__bottom">
                                                    <a href="instructor-details.html">
                                                        <div class="gridarea__small__img">
                                                            <img src="{{url('frontassets/img/grid/grid_small_2.jpg')}}" alt="grid">
                                                            <div class="gridarea__small__content">
                                                                <h6>Rinis Jhon</h6>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-md-12 col-sm-6 col-12" data-aos="fade-up">
                                        <div class="gridarea__wraper gridarea__wraper__2">
                                            <div class="gridarea__img">
                                                <a href="course-details.html"><img src="{{url('frontassets/img/grid/grid_3.png')}}" alt="grid"></a>
                                                <div class="gridarea__small__button">
                                            ...
                                            <div class="gridarea__content">
                                                ...
                                                <div class="gridarea__bottom">
                                                    ...
                                                    <a href="instructor-details.html">
                                                        <div class="gridarea__small__img">
                                                            <img src="{{url('frontassets/img/grid/grid_small_3.jpg')}}" alt="grid">
                                                            <div class="gridarea__small__content">
                                                                <h6>Micle Jhon</h6>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-md-12 col-sm-6 col-12" data-aos="fade-up">
                                        <div class="gridarea__wraper gridarea__wraper__2">
                                            <div class="gridarea__img">
                                                <a href="course-details.html"><img src="{{url('frontassets/img/grid/grid_4.png')}}" alt="grid"></a>
                                                <div class="gridarea__small__button">
                                            ...
                                            <div class="gridarea__content">
                                                ...
                                                <div class="gridarea__bottom">
                                                    ...
                                                    <a href="instructor-details.html">
                                                        <div class="gridarea__small__img">
                                                            <img src="{{url('frontassets/img/grid/grid_small_4.jpg')}}" alt="grid">
                                                            <div class="gridarea__small__content">
                                                                <h6>Micle Robin</h6>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-md-12 col-sm-6 col-12" data-aos="fade-up">
                                        <div class="gridarea__wraper gridarea__wraper__2">
                                            <div class="gridarea__img">
                                                <a href="course-details.html"><img src="{{url('frontassets/img/grid/grid_5.png')}}" alt="grid"></a>
                                                <div class="gridarea__small__button">
                                            ...
                                            <div class="gridarea__content">
                                                ...
                                                <div class="gridarea__bottom">
                                                    ...
                                                    <a href="instructor-details.html">
                                                        <div class="gridarea__small__img">
                                                            <img src="{{url('frontassets/img/grid/grid_small_5.jpg')}}" alt="grid">
                                                            <div class="gridarea__small__content">
                                                                <h6>Micle Robin</h6>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-md-12 col-sm-6 col-12" data-aos="fade-up">
                                        <div class="gridarea__wraper gridarea__wraper__2">
                                            <div class="gridarea__img">
                                                <a href="course-details.html"><img src="{{url('frontassets/img/grid/grid_6.png')}}" alt="grid"></a>
                                                <div class="gridarea__small__button">
                            ...
                            <div class="tab-pane fade" id="projects__two" role="tabpanel" aria-labelledby="projects__two">
                                ...
                                <div class="gridarea__wraper gridarea__wraper__2 gridarea__course__list" data-aos="fade-up">
                                    <div class="gridarea__img">
                                        <a href="course-details.html"><img src="{{url('frontassets/img/grid/grid_1.jpg')}}" alt="grid"></a>
                                        <div class="gridarea__small__button">
                                            <div class="grid__badge">Data & Tech</div>
                                        </div>
                                        <div class="gridarea__small__icon">
                                ...
                                <div class="gridarea__wraper gridarea__wraper__2 gridarea__course__list" data-aos="fade-up">
                                    <div class="gridarea__img">
                                        <img src="{{url('frontassets/img/grid/grid_2.jpg')}}" alt="grid">
                                        <div class="gridarea__small__button">
                                            <div class="grid__badge blue__color">Mechanical</div>
                                        </div>
                                        <div class="gridarea__small__icon">
                                ...
                                <div class="gridarea__wraper gridarea__wraper__2 gridarea__course__list" data-aos="fade-up">
                                    <div class="gridarea__img">
                                        <a href="course-details.html"><img src="{{url('frontassets/img/grid/grid_3.jpg')}}" alt="grid"></a>
                                        <div class="gridarea__small__button">
                                            <div class="grid__badge pink__color">Development</div>
                                        </div>
                                        <div class="gridarea__small__icon">
                                ...
                                <div class="gridarea__wraper gridarea__wraper__2 gridarea__course__list" data-aos="fade-up">
                                    <div class="gridarea__img">
                                        <a href="course-details.html"><img src="{{url('frontassets/img/grid/grid_4.jpg')}}" alt="grid"></a>
                                        <div class="gridarea__small__button">
                                            <div class="grid__badge green__color">Ui & UX Design</div>
                                        </div>
                                        <div class="gridarea__small__icon">
                                ...
                                <div class="gridarea__wraper gridarea__wraper__2 gridarea__course__list" data-aos="fade-up">
                                    <div class="gridarea__img">
                                        <a href="course-details.html"><img src="{{url('frontassets/img/grid/grid_5.png')}}" alt="grid5"></a>
                                        <div class="gridarea__small__button">
                                            <div class="grid__badge orange__color">Data & Tech</div>
                                        </div>
                                        <div class="gridarea__small__icon">
